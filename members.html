...
<body>
	...
	<div id="col2" class="span7">
		<div id="members">
			<img src="images/olisykes.jpg" alt="Oliver Sykes" class="span10">
			<h2>Oliver Sykes</h2>
			...
			<img src="images/jordanfish.jpg" alt="" class="span10">
			<h2>Jordan Fish</h2>
			...
			<img src="images/leemalia.jpg" alt="" class="span10">
			<h2>Lee Malia</h2>
			...
			<img src="images/jona.jpg" alt="" class="span10">
